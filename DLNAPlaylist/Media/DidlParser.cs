...
public static class DidlParser
{
    ...
    public static DidlInfo Parse(string? didl, string fallbackTitle)
    {
        ...
        try
        {
            ...
            if (res is not null)
            {
                ...
                duration = DlnaTime.TryParse(durAttr);
    ...
    private static MediaKind ClassifyUpnpClass(string upnpClass)
    {
    ...
    private static MediaKind ClassifyProtocolInfo(string protocolInfo)
    {
